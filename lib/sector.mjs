...
export const SECTORS = [
  { id: "k12", label: "K-12 education", pack: "k12", re: /\b(oecm|ontario education collaborative marketplace|education collaborative|school (district|board|division)|district school board|board of education|conseil scolaire|commission scolaire|school unit|unified school|independent school district|isd\b|usd\b|public schools|catholic schools?|elementary|secondary school|high school|academy)\b/i },
