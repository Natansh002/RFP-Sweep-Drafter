...
export const SECTORS = [
  ...
  { id: "nonprofit", label: "Nonprofit / association", pack: "nonprofit", re: /\b(association|society|foundation|charity|charitable|ymca|ywca|united way|non-?profit|not-for-profit|council for|human resource council|federation\b(?! of municipalities)|institute\b(?! of technology)|club|league)\b/i },
