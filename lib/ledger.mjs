...
const MACHINE = ["industry", "industryStatus", "title", "buyer", "country", "url", "channel", "closeDate", "estimatedValue", "score", "band", "reasons", "flags", "suggestedAssignee", "keyDates", "requirements", "competitors", "incumbent", "libraryMatches"];

const STICKY = new Set(["closeDate", "estimatedValue", "keyDates", "requirements", "competitors", "incumbent", "libraryMatches", "buyer", "country"]);
...
export default { STATUSES, DEFAULT_GO_NO_GO, goNoGoScore, isOpen, loadLedger, saveLedger, mergeRun, updateFinding, addAction, updateAction, getFinding };
