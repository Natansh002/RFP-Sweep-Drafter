...
const MACHINE = ["industry", "industryStatus", "title", "buyer", "country", "url", "channel", "closeDate", "estimatedValue", "score", "band", "reasons", "flags", "suggestedAssignee", "keyDates", "requirements", "competitors", "incumbent", "libraryMatches", "sourceText", "capabilities", "team", "publishedDate", "noticeType"];
