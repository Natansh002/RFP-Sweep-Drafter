...
export const CAPABILITIES = [
  { id: "erp", label: "ERP / Finance implementation", practice: "Finance Practice",
    title: ["ERP", "enterprise resource planning", "financial management system", "financial system", "finance system", "accounting system", "accounting software", "general ledger", "Dynamics 365", "Business Central", "fund accounting", "budgeting system"],
    body: ["chart of accounts", "accounts payable", "purchase order", "procure to pay", "fixed assets", "grant accounting", "fund accounting", "financial reporting"] },
  ...
  { id: "integration", label: "System integration", practice: "Technical Services",
    title: ["system integration", "systems integration", "integration services", "integration platform", "middleware", "API"],
    body: ["interfaces", "integrate with", "single sign-on", "data exchange", "web services", "iPaaS"] },
  { id: "migration", label: "Data migration", practice: "Data Practice",
    title: ["data migration", "data conversion", "legacy system replacement", "system replacement", "modernization", "modernisation"],
    body: ["legacy data", "data cleansing", "historical data", "conversion of", "migrate data", "cutover"] },
